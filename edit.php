		...
		<body style="background-color:#2980b9;">
			<div class="container" >
				<div class="row justify-content-center " style="margin:50px;">
					...
					<h3 style="text-align:center; color:white;">Form Update</h3>
						<div class="card" style="width: 18rem;">
							...
							<div class="card-body">
								<form action="#" method="POST">
										...
										<input class="btn btn-outline-dark btn-sm"  type="submit" name="submit" value="Simpan Update" style="float:right;">
								</form>
							</div>
						</div>        
					</div>
